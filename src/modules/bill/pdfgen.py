...
def create_pdf(current_month, fileName='bill_export'):
	...
	content.append(Paragraph("<font color=\"blue\" face=\"bitter-bold\">2. Electricity Charges</font>".format(static_data[1]), styleSheet['Heading2']))
	content.append(Line(460))
	...
	row8 = "<font face=\"domine\">{}{}{}</font>".format(
		Charges[7] + "(inc." + give_space("", 1) + "GST)",
		give_space("", 72),
		Amount[5])
	content.append(Line(460))
